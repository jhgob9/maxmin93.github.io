...
:heavy_exclamation_mark: 사용하는 자원에 따라 동작이 달라지는 클래스에는 정적 유틸리티 클래스나 싱글턴 방식이 적합하지 않다 
...
> :heavy_exclamation_mark: 메모리 누수의 주범
...
:heavy_exclamation_mark: finalizer 와 cleaner 의 용도
